...
extern "C"
{
    ...
    void startupWithUserId(const char *userIdentifier, bool isTapUser) {
        NSString *userIdentifierParam = [NSString stringWithUTF8String:userIdentifier];
        NSLog(@"%@", [NSString stringWithFormat:@"startup with userId: %@ ，isTapUser: %@"
        , userIdentifierParam
        , isTapUser?@"YES":@"NO"]);
        [AntiAddiction startupWithUserID:userIdentifierParam isTapUser:isTapUser];
    }

...
typedef SWIFT_ENUM(NSInteger, AntiAddictionRealNameAgeLimit, open) {
  ...
  AntiAddictionRealNameAgeLimitUNKNOWN_AGE = 100,
  AntiAddictionRealNameAgeLimitUNKNOWN_AGE_ADULT = 110,
};
...
enum AntiAddictionTipType : NSInteger;
...
@interface AntiAddictionService (SWIFT_EXTENSION(AntiAddictionService))
+ (void)checkRealNameStateWithClientId:(NSString * _Nonnull)clientId userId:(NSString * _Nonnull)userId useAgeRange:(BOOL)useAgeRange completion:(void (^ _Nonnull)(enum AntiAddictionRealNameAuthState, NSString * _Nonnull))completion failureHandler:(void (^ _Nonnull)(NSString * _Nonnull))failureHandler;
+ (void)checkRealNameByTapTokenWithClientId:(NSString * _Nonnull)clientId userId:(NSString * _Nonnull)userId useAgeRang:(BOOL)useAgeRang token:(TTSDKAccessToken * _Nullable)token completion:(void (^ _Nonnull)(enum AntiAddictionRealNameAuthState, NSString * _Nonnull))completion failureHandler:(void (^ _Nonnull)(NSString * _Nonnull))failureHandler;
+ (BOOL)hasComplianceAuthInLocalWithToken:(TTSDKAccessToken * _Nullable)token useAgeRang:(BOOL)useAgeRang SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, AntiAddictionServiceResult, open) {
  ...
  AntiAddictionServiceResultAgeStrict = 1100,
  AntiAddictionServiceResultInvalidClientOrNetworkError = 1200,
  AntiAddictionServiceResultRealNameStop = 9002,
};
...
SWIFT_CLASS("_TtC20AntiAddictionService19AntiAuthIdentifyTip")

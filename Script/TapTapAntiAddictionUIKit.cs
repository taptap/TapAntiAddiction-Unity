...
namespace TapTap.AntiAddiction
{
    public static class TapTapAntiAddictionUIKit
    {
        ...
        {
            var path = AntiAddictionSceneConst.GetPrefabPath(AntiAddictionSceneConst.VERIFY_FINISH_PANEL_NAME,
                false);
        ...
        {
            var path = AntiAddictionSceneConst.GetPrefabPath(AntiAddictionSceneConst.HEALTH_REMINDER_PANEL_NAME,
        ...
        {
            var path = AntiAddictionSceneConst.GetPrefabPath(AntiAddictionSceneConst.HEALTH_PAYMENT_PANEL_NAME,
                TapTapAntiAddictionManager.IsUseMobileUI());
        ...
        {
            var path = AntiAddictionSceneConst.GetPrefabPath(AntiAddictionSceneConst.RETRY_ALERT_PANEL_NAME,
                TapTapAntiAddictionManager.IsUseMobileUI());
            var retryAlert =

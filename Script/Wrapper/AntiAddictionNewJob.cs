...
namespace TapTap.AntiAddiction
{
    public sealed class AntiAddictionNewJob : IAntiAddictionJob
    {
        ...
        public int RemainingTime
        {
            get
            {
                if (TapTapAntiAddictionManager.CurrentPlayableResult == null) return 0;
                return TapTapAntiAddictionManager.CurrentPlayableResult.RemainTime;
            }
        }
        ...
        public int RemainingTimeInMinutes
        {
            get
            {
                ...
                if (seconds == 0) 
                    ...
                    return (int) UnityEngine.Mathf.CeilToInt(seconds / 60.0f);
            }
        }

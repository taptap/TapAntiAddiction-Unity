...
namespace TapTap.AntiAddiction 
{
    public class TapTapAntiAddictionManager
    {
        ...
        internal static AntiAddictionConfig AntiAddictionConfig => config == null ? config = new AntiAddictionConfig() : config;
        ...
        internal static PlayableResult CurrentPlayableResult { get; set; }
        ...
        public static void SetRegion(Region region)
        {
            ...
            if (antiAddictionHttpClient != null)
            {
                Type httpClientType = typeof(AntiAddictionHttpClient);
                var addAdditionalHeadersMtdInfo = httpClientType.GetMethod("ChangeAddtionalHeader", BindingFlags.Public | BindingFlags.Instance);
                addAdditionalHeadersMtdInfo?.Invoke(antiAddictionHttpClient, new object[]{"Accept-Language",
        ...
        internal static bool? useMobileUI;
